...
export default function UserModify({ onSave, user }) {
  ...
  const getInputStyle = (value, fieldError) => [
    AppStyles.input,
    value.toString().trim().length > 0 && fieldError === '' && { borderColor: '#3BB143' }
  ];
    ...
    <ScrollView contentContainerStyle={AppStyles.container}>
      <View style={AppStyles.formContainer}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 10 }}>
          <TextInput
            style={[
              ...getInputStyle(formData.cardExpireMonth, errors.cardExpireMonth || errors.cardExpireYear),
          ...
          <TextInput
            style={[
              ...getInputStyle(formData.cardExpireYear, errors.cardExpireMonth || errors.cardExpireYear),
              { width: 100 }
            ]}
            placeholder="YYYY"
            keyboardType="numeric"
